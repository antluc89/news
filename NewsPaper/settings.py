...
SECRET_KEY = 'django-insecure-3^l-jf&k!xrxbngy67+rr7&bc!=#j4)8^c8s#n278g87r#l0^9'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'antluc89@yandex.ru'
EMAIL_HOST_PASSWORD = 'wpnpyzsuususfqvy'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True

DEFAULT_FROM_EMAIL = 'antluc89@yandex.ru'

SERVER_EMAIL = 'antluc89@yandex.ru'
MANAGERS = (
    ('Sia', 'sia.lova@yandex.by')
)
